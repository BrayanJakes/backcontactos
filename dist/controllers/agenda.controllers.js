...
exports.listarAgenda = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield agenda_model_1.default.find((err, resp) => {
        if (err) {
...
exports.crearAgenda = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const newAgenda = new agenda_model_1.default(agenda);
...
exports.actualizarContacto = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { id } = req.params;
    yield agenda_model_1.default.findByIdAndUpdate(id, contacto, (err, resp) => {
        if (err) {
            return res.status(500).json({
                ok: false,
                mensage: 'Error en DB',
...
exports.eliminarContacto = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    yield agenda_model_1.default.findByIdAndRemove(id, (err, resp) => {
        if (err) {
            return res.status(500).json({
                ok: false,
                mensage: 'Error en DB',
